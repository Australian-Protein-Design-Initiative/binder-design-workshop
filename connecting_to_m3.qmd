...
- Select **T4**, **4 hours**. 
- Edit the **"Advanced Options"** and change the custom SBATCh command to: `sbatch --qos=desktopq --partition=desktop --gres=gpu:T4:1 --mem=100G --ntasks=6 --constraint=r9 --reservation=oct27workshop --account=pd27`.
   - (In particular, make sure you have `--reservation=oct27workshop`, `--account=pd27` and `--gres=gpu:T4:1`)
- Press **Launch**.
