...
You'll also need Nextflow for the `nf-binder-design` examples - see [Appendix: Foundational skills: Nextflow crash course](nextflow_crash_course.qmd#installing-nextflow).
