...
- How will I produce and test my _de novo_ binders ?
...
Open the vscode Terminal (``Ctrl+Shift+` ``) and make a new directory for your work:
...
Grab the coordinates for the PD-1/PD-L1 complex [3BIK](https://www.rcsb.org/structure/3BIK) (legacy PDB format).
...
In the context of _de novo_ binder design, a 'hotspot' is a residue on the target that is likely to make favourable interactions with residues on the _de novo_ binder. Hotspots help _guide_ the location and characteristics of the binder-target interface and can have a large (not always predictable) impact on _in silico_ success rates.
