...
It is very common, and good practise, to remove parts of the target coordinates to speed up computation of binders, and make better use of in-demand GPU resources. Sometimes truncation is the difference between _practical_ (24G VRAM), _possible_ (A100-80G or GH200-96G) and _not (yet) possible_ ( >100G VRAM on a single device).
